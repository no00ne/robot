...
#include "handpose_publisher/msg/hand_flange.hpp"
#include <cmath>
#include <chrono>
#include <stdexcept>
#include "LeapC.h"
...
public:
  ...
  : Node("leap_handpose_publisher") {
    ...
    pub_ = this->create_publisher<handpose_publisher::msg::HandFlange>("handpose/flange", 10);
...
private:
  void loop() {
    ...
    // publish
    auto msg_out = handpose_publisher::msg::HandFlange();
  ...
  rclcpp::Publisher<handpose_publisher::msg::HandFlange>::SharedPtr pub_;
