...
#ifndef HANDPOSE_INTERFACES__MSG__DETAIL__HAND_FLANGE__TRAITS_HPP_
#define HANDPOSE_INTERFACES__MSG__DETAIL__HAND_FLANGE__TRAITS_HPP_
...
inline void to_yaml(
  const handpose_interfaces::msg::HandFlange & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const handpose_interfaces::msg::HandFlange & msg)
{
  return handpose_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<handpose_interfaces::msg::HandFlange>()
{
  return "handpose_interfaces::msg::HandFlange";
}

template<>
inline const char * name<handpose_interfaces::msg::HandFlange>()
{
  return "handpose_interfaces/msg/HandFlange";
}

template<>
struct has_fixed_size<handpose_interfaces::msg::HandFlange>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<handpose_interfaces::msg::HandFlange>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<handpose_interfaces::msg::HandFlange>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // HANDPOSE_INTERFACES__MSG__DETAIL__HAND_FLANGE__TRAITS_HPP_
