...
#ifndef HANDPOSE_INTERFACES__MSG__DETAIL__HAND_FLANGE__STRUCT_HPP_
#define HANDPOSE_INTERFACES__MSG__DETAIL__HAND_FLANGE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__handpose_interfaces__msg__HandFlange __attribute__((deprecated))
#else
# define DEPRECATED__handpose_interfaces__msg__HandFlange __declspec(deprecated)
#endif
...
struct HandFlange_
{
  ...
  // pointer types
  using RawPtr =
    handpose_interfaces::msg::HandFlange_<ContainerAllocator> *;
  using ConstRawPtr =
    const handpose_interfaces::msg::HandFlange_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<handpose_interfaces::msg::HandFlange_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<handpose_interfaces::msg::HandFlange_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      handpose_interfaces::msg::HandFlange_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<handpose_interfaces::msg::HandFlange_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<handpose_interfaces::msg::HandFlange_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<handpose_interfaces::msg::HandFlange_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<handpose_interfaces::msg::HandFlange_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__handpose_interfaces__msg__HandFlange
    std::shared_ptr<handpose_interfaces::msg::HandFlange_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__handpose_interfaces__msg__HandFlange
    std::shared_ptr<handpose_interfaces::msg::HandFlange_<ContainerAllocator> const>
...
using HandFlange =
  handpose_interfaces::msg::HandFlange_<std::allocator<void>>;
...
#endif  // HANDPOSE_INTERFACES__MSG__DETAIL__HAND_FLANGE__STRUCT_HPP_
