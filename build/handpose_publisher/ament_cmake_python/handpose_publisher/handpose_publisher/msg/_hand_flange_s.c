...
bool handpose_publisher__msg__hand_flange__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("handpose_publisher.msg._hand_flange.HandFlange", full_classname_dest, 46) == 0);
  }
  handpose_publisher__msg__HandFlange * ros_message = _ros_message;
  {  // header
...
PyObject * handpose_publisher__msg__hand_flange__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("handpose_publisher.msg._hand_flange");
